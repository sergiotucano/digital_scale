...
class DigitalScale implements DigitalScaleImplementation {
  ...
  config() {
    ...
    switch(digitalScaleModel.toLowerCase()){
      ...
      case 'elgin dp1502':
      default:
        initString = String.fromCharCode(5) + String.fromCharCode(10) + String.fromCharCode(13);
        factor = 1;
        timeout = 6000;
        baundRate = 2400;
        stopBits = 1;
  ...
  Future<double> getWeight() async{
    ...
    try{
      ...
      serialPortReader.stream.listen((data) async {
        ...
        final String weightStr = decodedWeight.substring(1, (decodedWeight.length - 1)).trim();
